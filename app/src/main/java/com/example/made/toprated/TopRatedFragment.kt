...
import com.example.made.databinding.FragmentTopratedBinding
...
class TopRatedFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null) {
            ...
            movieAdapter.onItemClick = { selectedData ->
                ...
                view.findNavController().navigate(R.id.action_navigation_toprated_to_detail, bundle)
            }
    ...
    private fun observeData() {
        topRatedViewModel.topRated.observe(viewLifecycleOwner, { movie ->
            if (movie != null) {
                when (movie) {
